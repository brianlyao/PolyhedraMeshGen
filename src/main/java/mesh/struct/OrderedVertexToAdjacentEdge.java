 ...
 * winding order as the vertices of faces. All faces of the mesh must follow
 * the same winding order for this to succeed.
 * 
...
public class OrderedVertexToAdjacentEdge {
	...
	/**
	 * Get the list of edges adjacent to the specified vertex. The faces will
	 * be listed in the same order as the face vertices.
	 * 
