 ...
 * polyhedron to the sphere of desired circumradius. The Goldberg polyhedron
 * is generated by taking the dual polyhedron of an icosphere generated with
 * the given number of face subdivisions.
 *
 * @author Brian Yao
 */
public class Goldberg extends Polyhedron {
    ...
    /**
     * Generate a Goldberg polyhedron whose vertices are projected to the
     * sphere of given circumradius and is the dual polyhedron of the
     * icosphere with the given number of subdivisions.
     *
