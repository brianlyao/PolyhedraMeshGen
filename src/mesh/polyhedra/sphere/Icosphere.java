...
/**
 * An approximate sphere created by using a seed icosahedron and subdividing
 * its faces repeatedly, then projecting all vertices to the sphere of the
 * desired radius. Each subdivision divides each triangular face into four.
 * 
