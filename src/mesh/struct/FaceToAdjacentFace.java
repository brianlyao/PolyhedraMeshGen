...
/**
 * A data structure which, given a mesh, contains a map from each face in a
 * mesh to adjacent faces in the mesh. The adjacent faces will be arranged in
 * the same order as the vertices of the face (counterclockwise if the faces
 * follow convention).
 * 
