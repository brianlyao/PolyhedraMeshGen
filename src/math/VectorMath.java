...
public class VectorMath {
	...
	/**
	 * Returns the parametric interpolation of two vectors for parameter
	 * 0 <= t <= 1. At t = 0 this returns the start, and at t = 1 returns
	 * the end. In general, this returns start + (end - start) * t.
	 *
